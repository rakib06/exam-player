...
export const getASNTS = token => {
  return dispatch => {
    ...
    axios
      .get("http://https://rk-mcq.herokuapp.com/assignments/")
      .then(res => {
...
export const getASNTSDetail = (token, id) => {
  return dispatch => {
    ...
    axios
      .get(`http://https://rk-mcq.herokuapp.com/assignments/${id}/`)
      .then(res => {
...
export const createASNT = (token, asnt) => {
  return dispatch => {
    ...
    axios
      .post(`http://https://rk-mcq.herokuapp.com/assignments/`, asnt)
      .then(res => {
